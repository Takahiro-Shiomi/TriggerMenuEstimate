...
void TriggerMenuEstimate::OverlapRemoval()
{
...
bool TriggerMenuEstimate::ForwardForward(int roi1,int roi2,int sec1,int sec2)
{
    int dsec = abs(sec1-sec2);
    int droi = abs(roi1-roi2);
    bool flag=false;
...
bool TriggerMenuEstimate::ForwardEndcap(int source1,int source2,int a,int b,int c,int d)
{
    int roi1;
    int roi2;
    int sec1;
...
bool TriggerMenuEstimate::BarrelEndcap(int side1,int side2,int source1,int source2,int a,int b,int c,int d)
{
    int roi1;
    int roi2;
    int sec1;
