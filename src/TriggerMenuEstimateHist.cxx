...
void TriggerMenuEstimate::InitHist()
{
    ...
    for(int i=0;i!=15;i++){
    A_etaphi[i] = new TH2D(Form("A_etaphi%d",i),";#eta^{RoI};#phi^{RoI}",100,-2.5,2.5,96,-TMath::Pi(),TMath::Pi());
    T_etaphi[i] = new TH2D(Form("T_etaphi%d",i),";#eta^{RoI};#phi^{RoI}",100,-2.5,2.5,96,-TMath::Pi(),TMath::Pi());
    B_etaphi[i] = new TH2D(Form("B_etaphi%d",i),";#eta^{RoI};#phi^{RoI}",100,-2.5,2.5,96,-TMath::Pi(),TMath::Pi());
    E_etaphi[i] = new TH2D(Form("E_etaphi%d",i),Form("p_{T}=%dGeV;#eta^{RoI};#phi^{RoI}",i+3),100,-2.5,2.5,96,-TMath::Pi(),TMath::Pi());
